...
// For Loop : initialization, stopping condition, updation : starts with initil setting of i = 1, next comes to stopping condition and checks /n
// then comes in block calculation or print then after block of code comes to the updation ++, after once printing /n
// ++ becomes 2 because i is initially set to 1, after updation again stopping condition is being checked whether 2<5 then again comes in /n
//again printed , 
//For Loop
for (let i = 0; i < 10; i++) {
    const element = i;
