...
let con1 = dd < e;
let con2 = dd === e; // equal with type

console.log(con1 && con2) // returns false
console.log( "cond1 || con2 = " , con1 || con2 ) // returns false
console.log(!(dd < e)); //Actually false return True Opposite
console.log(!(dd === e)); // Actually false but returns true opposite
...
let a2 = 2;
let d = "2";
console.log(a1 + d);  // concatination operation answer 22 , string concatinates
...
let returnState = all && sum ? "khan" : 60;

//
const iceTeaprice : number = 75;
